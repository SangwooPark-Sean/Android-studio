    ...
    private void setUpCameraOutputs(int width, int height, int facingId) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                // We don't use a front facing camera in this sample. --> 사용으로 변경
                Integer facing = characteristics.get(CameraCharacteristics.LENS_FACING);
                if (facing != null && facing == facingId) { // CameraCharacteristics.LENS_FACING_FRONT
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.picture:
                takePicture();
                break;
            case R.id.change: // openCamera  CameraCharacteristics.LENS_FACING_FRONT
